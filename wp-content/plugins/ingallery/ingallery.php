...
# CURL timeout
add_filter('http_request_args', 'ingalleryHelper::httpRequestArgs', 100, 1);
add_action('http_api_curl', 'ingalleryHelper::httpApiCurl', 100, 1);
...
if(is_admin()){
	...
	add_shortcode('ingallery', 'ingalleryHelper::renderShortcode');
}
