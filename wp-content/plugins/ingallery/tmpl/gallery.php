...
if($cfg['layout_type']=='carousel'){
	...
	$carouselCfg.= '"responsive":[{"breakpoint": 500,"settings":{"slidesToShow":1,"slidesToScroll":1}}]';
	if($cfg['layout_rtl']==1){
		$carouselCfg.= ',"rtl": true';
	}
	$carouselCfg.= '}\'';
}
...
?>
<div class="<?php echo implode(' ',$classes);?>" id="<?php echo $galCSSid;?>" data-id="<?php echo $this->get('id');?>" data-filtered="0" data-page="<?php echo $this->get('page');?>" data-cfg="<?php echo str_replace('"','&quot;',json_encode($cfg));?>" <?php echo ($cfg['layout_rtl']==1?'dir="rtl"':'');?>>
	<?php
