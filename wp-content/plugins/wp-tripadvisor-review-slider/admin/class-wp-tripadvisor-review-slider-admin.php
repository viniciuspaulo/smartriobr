...
class WP_TripAdvisor_Review_Admin {
	...
	public function wptripadvisor_tripadvisor_section_developers_cb($args)
	{
		...
		echo "<p>Use this page to download your newest 10 TripAdvisor business reviews and save them in your Wordpress database. They will show up on the Review List page once downloaded. Any new reviews you get are downloaded once a day.</p><p>Note: The free version does not currently work for Vacation Rentals. The Pro version can download 3 for Vacation Rentals.</p>";
	}
