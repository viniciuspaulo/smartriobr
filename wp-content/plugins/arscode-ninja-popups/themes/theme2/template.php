...
<div class="snp-fb snp-theme2 snp-theme2<?php echo '-'.$POPUP_META['snp_theme']['color'].''; ?>">
    <div class="snp-wrap clearfix">
        ...
        <div class="snp-subscribe<?php if($POPUP_META['snp_theme']['type']=='social'){ echo' snp-subscribe-social'; }?>">
			...
			{
			  ?>
			  <form action="<?php if(snp_get_option('ml_manager') == 'html'){echo snp_get_option('ml_html_url');}else{echo '#';}?>" method="<?php echo $action; ?>" class="snp-subscribeform snp_subscribeform"<?php if(snp_get_option('ml_manager') == 'html' && snp_get_option('ml_html_blank')){echo ' target="_blank"';}?>>
